...
from ntt.cli.wizard.amd import ask_spec_id, prompt_amd_spec
from ntt.cli.wizard.smd import prompt_smd_spec
...
from ntt.models.smd import (
    Example,
    Priority,
    Requirement,
    SMDSpec,
)
from ntt.renderer.amd import save_amd
from ntt.renderer.smd import save_smd
